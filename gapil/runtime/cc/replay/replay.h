...
typedef uint64_t gapil_replay_remap_func(gapil_context* ctx, void* ptr);
...
DECL_GAPIL_REPLAY_FUNC(void, gapil_replay_init_data, gapil_context* ctx,
...
DECL_GAPIL_REPLAY_FUNC(void, gapil_replay_term_data, gapil_context* ctx,
                       gapil_replay_data* data);
...
DECL_GAPIL_REPLAY_FUNC(uint64_t, gapil_replay_allocate_memory,
                       gapil_context* ctx, gapil_replay_data* data,
...
DECL_GAPIL_REPLAY_FUNC(void, gapil_replay_reserve_memory, gapil_context* ctx,
                       gapil_replay_data* data, gapil_slice* sli, uint32_t ns,
...
DECL_GAPIL_REPLAY_FUNC(uint32_t, gapil_replay_add_resource, gapil_context* ctx,
                       gapil_replay_data* data, gapil_slice* slice);
...
DECL_GAPIL_REPLAY_FUNC(uint32_t, gapil_replay_add_constant, gapil_context* ctx,
...
// key.
DECL_GAPIL_REPLAY_FUNC(void, gapil_replay_add_remapping, gapil_context* ctx,
...
DECL_GAPIL_REPLAY_FUNC(uint64_t, gapil_replay_lookup_remapping,
                       gapil_context* ctx, gapil_replay_data* data,
                       uint64_t key);
